...
combined_test_cases = [
    ...
    (0, 0, cgt_allowance + 1, 0.10, 0),
    (0, 0, cgt_allowance + income_tax_threshold_40, income_tax_threshold_40*0.10, 0),
    (0, 0, cgt_allowance + income_tax_threshold_40 + 1, income_tax_threshold_40*0.10 + 0.20, 0),
    (1, 0, 0, 0, 0),
    ...
    (income_tax_threshold_20, 0, cgt_allowance + basic_rate_allowance, basic_rate_allowance*0.10, 0),
    (income_tax_threshold_20, 0, cgt_allowance + basic_rate_allowance + 1, basic_rate_allowance*0.10 + 0.20, 0),
    ...
    (income_tax_threshold_40, basic_rate_allowance*0.20, cgt_allowance + 1, 0.20, 0),
    ...
    (pa_limit, basic_rate_allowance*0.20 + (pa_limit - income_tax_threshold_40) * 0.40, cgt_allowance + 1, 0.20, 0),
    ...
    (income_tax_threshold_45, basic_rate_allowance*0.20 + (income_tax_threshold_45 - basic_rate_allowance) * 0.40, cgt_allowance + 1, 0.20, 0),
