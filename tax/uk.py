...
class IncomeTaxThresholds:
    # https://www.gov.uk/government/publications/rates-and-allowances-income-tax/income-tax-rates-and-allowances-current-and-past
    income_tax_threshold_20:int =  12570
    income_tax_threshold_40:int =  50270
    pa_limit               :int = 100000
    income_tax_threshold_45:int = pa_limit + 2*income_tax_threshold_20 # 2023/2024

    # https://www.gov.uk/marriage-allowance
    marriage_allowance     :int = 1260

assert IncomeTaxThresholds.income_tax_threshold_45 == 125140
...
# https://www.gov.uk/government/publications/benefit-and-pension-rates-2026-to-2027/proposed-benefit-and-pension-rates-2026-to-2027#state-pension
weeks_per_year = 365.25/7
state_pension_full = 241.30 * weeks_per_year
...
def tax(itt:IncomeTaxThresholds, income:float|int, capital_gains:float|int = 0, marriage_allowance:float|int = 0) -> tuple[float, float]:

    assert itt.income_tax_threshold_45 >= itt.pa_limit + 2*itt.income_tax_threshold_20

    # https://www.gov.uk/income-tax-rates/income-over-100000
    personal_allowance   :float = max(itt.income_tax_threshold_20 + marriage_allowance - max(income - itt.pa_limit, 0)*0.5, 0)
    basic_rate_allowance :float = itt.income_tax_threshold_40 - itt.income_tax_threshold_20
    higher_rate_allowance:float = itt.income_tax_threshold_45 - personal_allowance - basic_rate_allowance
