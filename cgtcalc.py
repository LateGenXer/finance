...
class Calculator:
    ...
    def __init__(self, rounding:bool=True):
        self.places:int = 0 if rounding else 2
        self.securities: dict[str, list[Trade]] = {}
...
def main() -> None:
    ...
    calculator = Calculator(rounding=args.rounding)
